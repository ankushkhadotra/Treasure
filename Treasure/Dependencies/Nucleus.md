...
\begin{tikzpicture}[
    ...
    compartment/.style = {
        rectangle, draw=black, fill=gray!10, rounded corners, 
    ...
    filament/.style = {
        ...
        minimum width=6cm, minimum height=0.8cm, 
        font=\sffamily, align=center, text width=5.8cm
    }, 
    % Rings (Added explicit text width to fix compilation line-break bugs)
    ring/.style = {
        ellipse, draw=black, fill=orange!10, 
        minimum width=6.5cm, minimum height=1.2cm, 
        font=\sffamily, align=center, text width=5.5cm
    }, 
